...
const Calculation=({n, setn,k,setk,n1,setn1,dim, setm, modal,calc, setcalc, setp, settab, setdim, setErrorr})=>{
  ...
  const formap=Array.from(Array(4).keys())
                            ...
                            >
                              ...
                              <span style={{textDecoration: "none"}}>
                                  {((!k && Number.isInteger(k)==false) || (!n1 && Number.isInteger(n1)===false))?
                                    "\\((1-x^2)y''+(2n+1)xy'+ky=0\\)":`\\((1-x^2)y''${n1===0?"+xy":'+'+ (2*(n1*1)+1)+'xy'}'${(k*1)<0? "": "+"}${k*1}y=0\\)`}</span>
                              </a>
                              </div>
                            </motion.div>
                          {
                            (!select) && (
                              ...
                              >
                                ...
                                <div className="row align-items-center text-center justify-content-center">
                                  ...
                                  <Link to={(n1 || Number.isInteger(n1)===true) && (k || Number.isInteger(k)===true)?"/solution5":""}><motion.button variants={Variants} whileHover="hover" className="btn textpele px-2 col-lg-2 col-4" id="btn--select" onClick={err}>Proceed</motion.button></Link>
                                  </div>
            ...
            <section id="topics">
              <div className="container-md mt-5">
                ...
                <div className="g-1 justify-content-lg-around align-items-center">
                  <div className="col-12 col-lg-7 fs-5" style={w>350?{margin: "auto"}: {width:"100%"}}>
                    <header id="logo1" className="textpep py-3 beginner">
                      ...
                      <div className="left1 my-0">\(for\ n=0,\ \ \ \ \ v=k+1\)</div>
                      <div className="my-0 py-0">\((1-x^2)y''+xy'+ky=0\)</div>
                      <div>{"\\(F_0(x)=\\)"}<span className="npallf">{array[0]}</span><span>{"\\(^{\\sqrt{V}}\\)"}</span><span className="mx-1 npallf">{"\\(x+i\\sqrt{v(1-x^2)}\\)"}</span></div>
                      <div>{"\\(G_0(x)=\\)"}<span className="npallf">{array[1]}</span>{"\\(^{\\sqrt{V}}\\)"}<span className="mx-1 npallf">{"\\(x-i\\sqrt{v(1-x^2)}\\)"}</span></div>
                      <div className="container table-responsive pt-0 my-3" style={{width:"fit-content", overflowX:"hidden", overflowY:"hidden"}}>
                        ...
                        >
                      <div className="left1 my-0">\(for\ n=1,\ \ \ \ \ v=k+4\)</div>
                      <div className="my-0 py-0">\((1-x^2)y''+3x+ky=0\)</div>
                      <div className="d-flex align-items-center">{"\\(F_1(x)=\\)"}<span className="npallf">{array[0]}</span><span>{"\\(^{\\sqrt{V}}\\)"}</span><div className="mx-1 npallf d-flex">{"\\(3x^2+3ix\\sqrt{v(1-x^2)}-(v-1)(1-x^2)\\)"}</div></div>
                      <div className="d-flex align-items-center">{"\\(G_1(x)=\\)"}<span className="npallf">{array[1]}</span>{"\\(^{\\sqrt{V}}\\)"}<span className="mx-1 npallf d-flex">{"\\(3x^2-3ix\\sqrt{v(1-x^2)}-(v-1)(1-x^2)\\)"}</span></div>
                        </motion.div>
                      </div>
                      <div className="container table-responsive pt-0 my-3" style={{width:"fit-content", overflowX:"hidden", overflowY:"hidden"}}>
                        <motion.div className=""
                        ...
                        >
                      <div className="left1 my-0">\(for\ n=2,\ \ \ \ \ v=k+9\)</div>
                      <div className="my-0 py-0">\((1-x^2)y''+5x+ky=0\)</div>
                      <div className="d-flex align-items-center">{"\\(F_4(x)=\\)"}<span className="npallf">{array[0]}</span><span>{"\\(^{\\sqrt{V}}\\)"}</span><div className="mx-1 npallf d-flex">{"\\(15x^3+15ix^2\\sqrt{v(1-x^2)}-(6v-9)x(1-x^2)-i(v-4)\\sqrt{v(1-x^2)^3}\\)"}</div></div>
                      <div className="d-flex align-items-center">{"\\(G_4(x)=\\)"}<span className="npallf">{array[1]}</span>{"\\(^{\\sqrt{V}}\\)"}<span className="mx-1 npallf d-flex">{"\\(15x^3-15ix^2\\sqrt{v(1-x^2)}-(6v-9)x(1-x^2)+i(v-4)\\sqrt{v(1-x^2)^3}\\)"}</span></div>
                        </motion.div>
                      </div>
                      <div className="container table-responsive pt-0 my-3" style={{overflowX:"hidden", overflowY:"hidden"}}>
                        ...
                        >
                      <div className="left1 my-0">\(for\ n=3,\ \ \ \ \ v=k+16\)</div>
                      <div className="my-0 py-0">\((1-x^2)y''-11x+ky=0\)</div>
                      <div className="max" >{"\\(F_5(x)=\\)"}<div className="npallf">{array[0]}</div><div>{"\\(^{\\sqrt{V}}\\)"}</div><div className="mx-1 npallf d-flex">{"\\(105x^4+105ix^3\\sqrt{v(1-x^2)}-(45v-90)x^2(1-x^2)-i(10v-55)x\\sqrt{v(1-x^2)^3}+(v^2-10v+9)(1-x^2)^2\\)"}</div></div>
                      <div className="max">{"\\(G_5(x)=\\)"}<span className="npallf">{array[1]}</span>{"\\(^{\\sqrt{V}}\\)"}<span className="mx-1 npallf d-flex">{"\\(105x^4-105ix^3\\sqrt{v(1-x^2)}-(45v-90)x^2(1-x^2)+i(10v-55)x\\sqrt{v(1-x^2)^3}+(v^2-10v+9)(1-x^2)^2\\)"}</span></div>
                        </motion.div>
                      </div>
                    </header>
                  </div>
