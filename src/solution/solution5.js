                ...
                <section>
                    <div className="container-lg" id="pdf">
                        ...
                        <div className={dim.w>700?"fs-5":"beginner"}>
                            ...
                            <div className="text-start ms-0 pe-2 ps-0 fs-5 mb-3">
                                {
                                    n===0 && (<><div className="d-flex align-items-center">{"\\(F_0(x)=\\)"}<span className="npallf">{array1[0]}</span><span>{`\\(^{${sv}}\\)`}</span><span className="mx-1 npallf">{`\\(x+i\\sqrt{${v1}(1-x^2)}\\)`}</span></div>
                                    <div className="d-flex align-items-center">{"\\(G_0(x)=\\)"}<span className="npallf">{array1[1]}</span><span>{`\\(^{${sv}}\\)`}</span><span className="mx-1 npallf">{`\\(x-i\\sqrt{${v1}(1-x^2)}\\)`}</span></div></>)
                                }
                                {
                                    n===1 && (<><div className="d-flex align-items-center">{"\\(F_1(x)=\\)"}<span className="npallf">{array1[0]}</span><span>{`\\(^{${sv}}\\)`}</span><span className="mx-1 npallf d-flex">{`\\(3x^2+3ix\\sqrt{${v1}(1-x^2)}-(${v1-1})(1-x^2)\\)`}</span></div>
                                    <div className="d-flex align-items-center">{"\\(G_1(x)=\\)"}<span className="npallf">{array1[1]}</span><span>{`\\(^{${sv}}\\)`}</span><span className="mx-1 npallf d-flex">{`\\(3x^2-3ix\\sqrt{${v1}(1-x^2)}-(${v1-1})(1-x^2)\\)`}</span></div>
                                    </>)
                                }
                                {
                                    n===2 && (<><div className="d-flex align-items-center">{"\\(F_2(x)=\\)"}<span className="npallf">{array1[0]}</span><span>{`\\(^{${sv}}\\)`}</span><div className="mx-1 npallf d-flex">{`\\(15x^3+15ix^2\\sqrt{${v1}(1-x^2)}-(${6*v1-9})x(1-x^2)-i(${v1-4})\\sqrt{${v1}(1-x^2)^3}\\)`}</div></div>
                                            <div className="d-flex align-items-center">{"\\(G_2(x)=\\)"}<span className="npallf">{array1[1]}</span><span>{`\\(^{${sv}}\\)`}</span><div className="mx-1 npallf d-flex">{`\\(15x^3-15ix^2\\sqrt{${v1}(1-x^2)}-(${6*v1-9})x(1-x^2)+i(${v1-4})\\sqrt{${v1}(1-x^2)^3}\\)`}</div></div>
                                    </>)
                                }
                                {
                                    n===3 && (<><div className="max">{"\\(F_3(x)=\\)"}<div className="npallf">{array1[0]}</div><div>{`\\(^{${sv}}\\)`}</div><span className="mx-1 npallf d-flex">{`\\(105x^4+105ix^3\\sqrt{${v1}(1-x^2)}-(${45*v1-90})x^2(1-x^2)-i(${10*v1-55})x\\sqrt{${v1}(1-x^2)^3}+(${v1**2-10*v+9})(1-x^2)^2\\)`}</span></div>
                                                <div className="max">{"\\(G_3(x)=\\)"}<div className="npallf">{array1[1]}</div><div>{`\\(^{${sv}}\\)`}</div><span className="mx-1 npallf d-flex">{`\\(105x^4-105ix^3\\sqrt{${v1}(1-x^2)}-(${45*v1-90})x^2(1-x^2)+i(${10*v1-55})x\\sqrt{${v1}(1-x^2)^3}+(${v1**2-10*v+9})(1-x^2)^2\\)`}</span></div>
                                    </>)
                                }
                            </div>
                            </div>
                            ...
                            {
                                n===0 && (
                                    <div className="d-flex align-items-center">{`\\(P_${n}(x)=\\)`}<span className="npallf">{`\\(x.S-\\sqrt(${v1}(1-x^2)).C\\)`}</span></div>
                                )
                            }
                            {
                                n===1 && (
                                    <div className="d-flex align-items-center">{`\\(P_${n}(x)=\\)`}<span className="npallf">{`\\(3x^2.S-3x\\sqrt(${v1}(1-x^2)).C-(${v1-1})(1-x^2).S\\)`}</span></div>
                                ) 
                            }
                            {
                                n===2 && (
                                    <div className="d-flex align-items-center">{`\\(P_${n}(x)=\\)`}<span className="npallf">{`\\(15x^3.S-15x^2\\sqrt(${v1}(1-x^2)).C-(${6*v1-9})(1-x^2)x.S + (${v1-4})\\sqrt{${v1}(1-x^2)^3}\\)`}</span></div>
                                ) 
                            }                            
                            {
                                n===3 && (
                                    <div>{`\\(P_${n}(x)=\\)`}<span className="npallf">{`\\(105x^3.S-105x^2\\sqrt{${v1}(1-x^2)}.C-(${45*v1-90})(1-x^2)x.S + (${10*v1-55})\\sqrt{${v1}(1-x^2)^3} + (${v1**2-10*v1+9})(1-x^2)^2\\)`}</span></div>
                                ) 
                            }
                            </div>
                            </div>
                    ...
                    <div>
                        ...
                        <div className="text-start ms-0 pe-2 ps-0 fs-5 mb-3">
                            {
                                n===0 && (
                                    <div className="d-flex align-items-center">{`\\(Q_${n}(x)=\\)`}<span className="npallf">{`\\(-x.C-\\sqrt(${v1}(1-x^2)).S\\)`}</span></div>
                                )
                            }
                            {
                                n===1 && (
                                    <div className="d-flex align-items-center">{`\\(Q_${n}(x)=\\)`}<span className="npallf">{`\\(-3x^2.C-3x\\sqrt(${v1}(1-x^2)).S+(${v1-1})(1-x^2).C\\)`}</span></div>
                                ) 
                            }
                            {
                                n===2 && (
                                    <div className="d-flex align-items-center">{`\\(Q_${n}(x)=\\)`}<span className="npallf">{`\\(-15x^3.C-15x^2\\sqrt(${v1}(1-x^2)).S+(${6*v1-9})(1-x^2)x.C + (${v1-4})\\sqrt{${v1}(1-x^2)^3}\\)`}</span></div>
                                ) 
                            }
                            
                            {
                                n===3 && (
                                    <div className="d-flex align-items-center">{`\\(Q_${n}(x)=\\)`}<span className="npallf">{`\\(-105x^4.S-105x^3\\sqrt(${v1}(1-x^2)).C+(${45*v1-90})(1-x^2)x^2.S + (${10*v1-55})x\\sqrt{${v1}(1-x^2)^3} -(${v1**2-10*v1+9})(1-x^2)^2\\)`}</span></div>
                                ) 
                            }
                        </div>
                        </div>
