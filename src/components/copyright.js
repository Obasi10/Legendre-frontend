...
const Copyright=({dim})=>{
    ...
    return (
        ...
        <motion.footer className="align-items-center textpop copyright">
                {(<span>&copy; 2024</span>)}<span className="nav-item px-2 text-primary">Developer: <motion.span variants={Variants} animate="designer"><Link to="/about" className="Designer" 
