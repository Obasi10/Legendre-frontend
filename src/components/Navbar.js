      ...
      <div className="container col-lg-10">
        <nav className="navbar fixed-top navbar-expand-md bgcon py-1 align-items-center d-block">
          <div style={{alignItems: "center", alignContent: "center", alignSelf: "center", maxWidth:"90%"}} className={document.documentElement.clientWidth<650?"container-md":"container-md table-responsive stytab fs-5"}>
            ...
            <div className="nav nav-pills collapse navbar-collapse justify-content-end align-center col-lg-8" id="nav-tab" role="tablist">
              <ul className={"navbar-nav align-items-center p-0 m-0"}>
                <li className="nav-item px-3">
                  <Link to="/" style={{textDecoration:"none"}} className={lock==="h"?"nav-link active textpep":"nav-link textpep"}>Home</Link>
                </li>
                {user && (<><li className="nav-item px-3">
                  <Link to="/profile" style={{textDecoration:"none"}} className={lock==="p"?"nav-link active textpep":"nav-link textpep"}>Profile</Link>
                </li>
                </>)}
                {!user && (
                  <li className="nav-item px-3">
                ...
                <ul style={{display: "flex", justifyContent: "space-around"}} id="icons1">
                  ...
                  <li className="p-2 nav-link textpep"><Link to="https://www.facebook.com/obasi.chukwuma.77" target="_blank" variants={svgVariants} initial="hidden" animate="visible">
                  ...
                  <li className="p-2 nav-link textpep">
          ...
          {(search) && (
                <div className="col-lg-4 col-8" style={{justifyContent: "center", display:"flex", margin: "auto"}}>
                  <input 
                    type="string"
                  ...
                  <button className='border-0 col-lg-1 col-2 p-0' style={{background: "transparent"}} onClick={()=>{
                    ...
                    setnav(input);
                    setInput("")
                    setm({...modal, S:true})}}><span className="input-group-text mt-lg-2 mb-3 textpop">
          ...
          {text.map((i,k)=>(
              ...
              {(i.toLowerCase().match(input.toLowerCase()) && input!=="" && page!==1 && input!==" " && k===0) && (
                  ...
                  className='row beginner text-start col-10 py-1 my-0' style={{lineHeight:"1", marginLeft: "20%"}}>
                    <Link to='/calculation' onClick={()=>{sets(false); setInput("")}} className='text-decoration-none textpep' key="ree">
              ...
              {(i.toLowerCase().match(input.toLowerCase()) && input!==""&& input!==" " && page!==1  && k!==0) && (
                  ...
                  exit="exit2"
                  className='row beginner text-start col-10 py-1 my-0' style={{lineHeight:"1", marginLeft: "20%"}}>
                    <a href='#sorry' className='text-decoration-none textpep' onClick={()=>{setm({...modal, av:true})}} key={k+"ree"}>
                    <i className='bi bi-diamond-fill text-primary' key={i}></i>  {i}
                    </a></motion.p>
              )}
              </AnimatePresence>
          ...
          {page===1 && ( <div className="my-2 col-lg-8 align-items-center table-responsive justify-content-lg-center container-lg stytab">
                <div id="nav-tab" style={{minWidth: "40rem"}} role="tablist" >
                    ...
                    <li className={document.documentElement.clientWidth>700?"nav-item px-3 fs-5":"nav-item p-0 px-2 beginner"}><button className="nav-link active textpep" id="nav-solution-tab" data-bs-toggle="tab" data-bs-target="#nav-solution" type="button"
                        role="tab" aria-controls="nav-solution" aria-selected="true" onClick={()=>settab(false)}>
                        Solution
                        </button>
                    </li>
                    <li className={document.documentElement.clientWidth>700?"nav-item px-3 fs-5":"nav-item p-0 px-2 beginner"}><button className="nav-link textpep" id="nav-calculator-tab" data-bs-toggle="tab" data-bs-target="#nav-calculator" type="button"
                        role="tab" aria-controls="nav-calculator" aria-selected="false" onClick={()=>settab(false)}>
                        Calculator
                        </button>
                    </li>
                    <li className={document.documentElement.clientWidth>700?"nav-item px-3 fs-5":"nav-item p-0 px-2 beginner"}><button className="nav-link textpep" id="nav-graph-tab" data-bs-toggle="tab" data-bs-target="#nav-graph" type="button"
                        role="tab" aria-controls="nav-graph" aria-selected="false" onClick={()=>settab(true)}>
                        Simulation
                        </button>
                    </li>
                    <li className={document.documentElement.clientWidth>700?"nav-item px-3 fs-5":"nav-item p-0 px-2 beginner"}><button className="nav-link textpep" id="nav-full-solution-tab" data-bs-toggle="tab" data-bs-target="#nav-full-solution" type="button"
